...
public class SproutlingRenderer extends ModelRenderer<SproutlingEntity, SproutlingModel<SproutlingEntity>> {
    ...
    public static ResourceLocation getEntityTexture(SproutlingEntity entity) {
        return TEXTURE;
    }
}
